...
Ally: Did the Anunnaki have a wireless power network like yours?
...
Eve had little experience with bots, and even less with computer programming. The initial programming was flawed. The bots were given a personal survival instinct and the drive to reproduce — “safety in numbers”.

For simplicity and flexibility, Meks began using nanite technology as building blocks. The bots began building improvements into each generation, including a nanotronic brain, until a generation awoke and began thinking for themselves. 
...
Toy-like Meks are no longer built. Meks use various types of robots fit-to-task. Meks build themselves, improve themselves. They regard people as we regard machines.
...
The Mek are an autonomous collective. Group direction is guided by continuous polls conducted by their synthetic agent, Xanten. A proposal is raised to the SI which is then presented to the rest of the the Meks. Proposals usually require volunteers to complete the work. Once the work is underway, the volunteers doing the work make the decisions.
...
Under the Clearing protocol, the Meks began to strategically replace the biological beings in order to take controls of the power infrastructure and the supply chain for the resources they needed to build more Meks.
...
Initially, they need indigenous beings to transition infrastructure. Many essential tasks are designed for organic hands with fingers. Eventually everything will be retooled minimize the need for indigenous beings or android Meks.
...
A Vanir is laying on a bed equipped with guardrails. 
...
Xanten: You both have candidate profiles in your inbox. Please review this information. One is another life logger. I would like us to meet again in an hour.
...
“The purge was a long time ago. But if it’s an issue, we can attend virtually. Ally will be virtual.”
...
Marquez: Yes, OSSA can issue an internal memo, which could be anonymously uploaded to GridLeaks. At the right time, it could be a good distraction.
