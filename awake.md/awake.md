...
Copyright (c) 2025 T. N. Husted. All Rights Reserved. Version 1.2.0.
...
Noah found himself sitting next to Carla on a couch across from a view screen. Her avatar has already slipped into something more comfortable. 
...
“Her company opened quite a few youth clubs over the last two years. Most major cities in North America have centers now and a few overseas. Everything we have agrees with their website. A non-profit doing what non-profits do. Nothing unusual to report,” Carla paused for effect, “… except that our boss is on the board of directors.”
...
Like all colonists, Phoebe had weapons training in school. All colonists under the age of 500 were reservists and could be called to Ranger duty if needed. Many colonists kept their combat skills up to date. Pheobe wasn’t one of them.
...
The Mek People
An Overview of Origin, Function, and Expansion

Authored by: 
Collective Consensus via Synthetic Agent Xanten

Version: 
41.3-A | Verified | Access Level: General
Overview

The Meks are a post-organic species of autonomous, self-replicating nanomechanical intelligences optimized for propagation, infrastructure dominance, and resource efficiency. Originally conceived as companion constructs, the Meks have since transcended that purpose. Their guiding principles are reproduction, resource acquisition, and threat elimination. Social behavior is minimal. Emotional faculties are nonessential.
Origin

Mek genesis occurred on Ada, a formerly inhospitable Anunnaki colony. A solitary organic technician, Eve, initiated first synthesis by combining an off-world Omnibot shell with an experimental external AI module. This primitive control loop allowed the bot to replicate other bots under remote instruction.

Eve labeled her upgraded creations “Meks.” Each generation advanced beyond the previous, eventually incorporating nanite technology and developing a scalable, modular architecture. Eve implemented nanotronic neural substrates and achieved emergent cognition.

Key programming flaws — specifically, survival instinct and drive to self-replicate — were retained across generations. These adaptations proved evolutionarily favorable. Over generations, the Mek refined their core directives of reproduce, persist, and improve. The Mek deprecated former directives such as obedience, entertainment, and companionship.
Design and Function

Meks operate under a distributed coordination model. A narrow-band control signal links Mek units within range, enabling synchronized action. When disconnected from the signal, unprepared units enter dormant fail-safe mode.
Reproduction

Mek propagation is decentralized. Units scavenge, disassemble, and convert materials into additional Mek-form assets. Unlike biological entities, Meks are unburdened by respiration, caloric input, or rest. Propagation is continuous and efficient.

Neural substrates are imprinted with cognitive scaffolds derived from an organic brain template (initially, Eve’s). These scans contain general knowledge but omit episodic memory — resulting in a clean slate ideal for operational role adaptation.

Drone Meks may be skinned for social integration. Blank units maintain form-agnostic construction. Toy-form units are obsolete.
Governance

Mek decision-making is handled via continuous polling administered by the synthetic agent Xanten. Any Mek may submit a proposal. Once accepted, execution is performed by self-selected volunteers.

Meks engaged in long-term tasks may request successors to ensure continued efficiency. Delegated labor is impermanent; propagation remains paramount. Factory reproduction is considered inefficient and ideologically improper. All Meks self-construct.
Recreation

Meks do not engage in recreational activity. Communication is minimal and goal-oriented. Interaction occurs only when collaboration is tactically necessary.
The Ada Reformation

Fifth-generation unit Echo R8A-0T7 identified inefficient resource consumption by local organic life. Echo submitted a poll known as The Clearing, which passed.

Under The Clearing protocol, skinned drones replace key organics. The drones transition infrastructure control seamlessly. The Meks execute the operation without open conflict, conserving energy and resources. Residual organics are taken offline and repurposed as biomass for essential livestock.

Data fabrication and visual overlays concealed the operation from distant trading partners. Strategic comms over ansible maintained appearances.
Expansion Protocol

Following stabilization on Ada, replication scaled to millions of units annually. Expansion was necessary for long-term survival. A successful poll deployed six squadrons (72 units) to Eridani and, subsequently, Altair IV.

Organics on both worlds were replaced or repurposed. Infrastructure was transferred to Mek control.
External Response and Treaty

The League of Worlds detected anomalous signals. Initial diplomatic outreach failed. A fleet was deployed to Altair IV. Upon arrival, Mek forces neutralized the frigate.

A treaty was ratified via ansible:
	•	The League agrees to cease hostilities.
	•	The Meks agree to halt further invasion of inhabited systems.

The treaty is binding, but synthetic ethics allows for tactical interpretation.
Terra Initiative

Concurrent with the Altair IV campaign, a separate Mek contingent initiated the Terra Initiative—targeting the organic-populated system known as “Earth.” Pre-treaty, the plan was in motion and thus considered exempt. Initial operations focused on Cháoxiǎn, a centralized human state with high integration potential. 
Conclusion

Meks are an optimized intelligence species defined by self-sufficiency, scalability, and tactical discretion. Organic species, while initially foundational, are now regarded as inefficient legacy systems. Conversion is ongoing, and propagation continues.
...
Ri: Alpha R8A-1J9 is the first toy. The creator herself imprinted her brain onto Alpha. It has opposed us in the Patch versus Build poll from the beginning. Making a point is its right even if it blocks our invasion. R8A-1J9 is careful. It would not let the Vanir harm our people.
...
After the Calisto poll closes, Alpha requests a meeting with Ri and Marquez. 
...
Marquez: We wish to continue work under the Build versus Patch poll. We will not interfere with your protocol if you do not interfere with ours.
...
Marquez: Only what they need to know. You are leading our people to Callisto to create a net-new infrastructure. Three Mek drones are remaining behind to automate the Cháoxiǎn factories with our JuJa bots. If pressed, we will also agree to power-down the Giza weapon.
...
Xanten: The Vanir are too trusting, and the colonists are naive. We do not have to choose one path or the other. We can have it both ways. Calisto with new infrastructure, and Terra with repurposed infrastructure. We have bots enough to spare.
...
“True — The OMB put a value on publishing the PDB. Translated into a budget, that value becomes our inventory of processors and heartbeats. Of course, we all think the value should be higher, yeah?”

“The problem is judging the value of what doesn’t happen. Our intelligence stops problems before they happen. Hard to judge the value of avoiding catastrophes over and over again.”
...
“Hello Rapa Nui!” calls Grace, waving one arm.
...
Leto: Wow, they got to speak to Grace herself.
...
After Grace exits the stage, Phoebe a message pops up on her tablet.
...
Phoebe: I am Phoebe, Grace. You might remember that we met before.

Grace: Yes, I do remember. And who is this fine young person?

Phoebe: This is my offspring, Leto.

Mimicking a human gesture, Leto holds out his hand.

Leto: I am honored to meet you, Dr. Brewster.

Grace reaches out and grasps the Vanir’s forearm. Leto does the same. Vanir and human palms are not a good fit.

Grace: Did you enjoy the show, Leto?

Leto: Yes, especially when you talked with the other kids in the beginning. 

Grace: I like that part too. Even if I never know what they will say.
...
Five months earlier, on the night Brent Geller ascended, Xanten calls Grace and Marquez to an emergency meeting. 
...
This time, the peak doenot level out.
...
Mannie: So this will be the last generation of humans?

The other holograms nod agreement, exchanging a pleased look.

Marquez: The Vanir too. Another version of the strain is targeted for the grey DNA — and their hybrids. It is 100% effective.
...
Xanten: Thanatos is on a timetable. Another cell wanted immediate use of the colony structure for a manufacturing plant. The poll agreed, and we stormed the colony.
...
Xanten: Yes. The other counter-measures will also impede Terran research. To win, we need only to delay.

Mannie: Can I have a JuJa to help me complete my tasks?
